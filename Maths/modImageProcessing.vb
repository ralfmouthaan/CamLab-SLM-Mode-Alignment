...
Namespace ImageProcessing
    Module modImageProcessing
        ...
        Public Sub ZeroPad(ByRef Img(,) As Numerics.Complex, ByVal NewSizeX As Integer, ByVal NewSizeY As Integer)
            ...
            Dim Input(OldSizeX - 1, OldSizeY - 1) As Numerics.Complex
            Dim Output(NewSizeX - 1, NewSizeY - 1) As Numerics.Complex
        ...
        Public Sub SaveImgToFile(ByVal Img(,) As Numerics.Complex, ByVal Filename As String)
            ...
            For i = 0 To UBound(Img, 1)
                For j = 0 To UBound(Img, 2)
                    writer.Write(TypeConversions.ComplexToComplexString(Img(i, j)))
                    If j < UBound(Img, 2) Then writer.Write(vbTab)
                Next
                If i < UBound(Img, 1) Then writer.WriteLine()
            Next
        ...
        Public Sub OverlapIntegral(ByVal Img1(,) As Numerics.Complex, ByVal Img2(,) As Numerics.Complex, ByVal Normalise As Boolean, ByRef Result As Double)
            ...
            For i = 0 To Img1.GetLength(0) - 1
                For j = 0 To Img1.GetLength(1) - 1
                    ...
                    If (i - Img1.GetLength(0)) ^ 2 + (j - Img1.GetLength(1)) ^ 2 > Img1.GetLength(0) ^ 2 Then Continue For
        ...
        End Sub
        Public Sub OverlapIntegral(ByVal Img1(,) As Numerics.Complex, ByVal Img2(,) As Double, ByVal Normalise As Boolean, ByRef Result As Double)
        ...
        End Sub
        Public Sub OverlapIntegral(ByVal Img1(,) As Numerics.Complex, ByVal Img2(,) As Integer, ByVal Normalise As Boolean, ByRef Result As Double)
        ...
        End Sub
        Public Sub OverlapIntegral(ByVal Img1(,) As Double, ByVal Img2(,) As Double, ByVal Normalise As Boolean, ByRef Result As Double)
        ...
        End Sub
        Public Sub OverlapIntegral(ByVal Img1(,) As Double, ByVal Img2(,) As Integer, ByVal Normalise As Boolean, ByRef result As Double)
        ...
        End Sub
        Public Sub MagnitudeOverlap(ByVal Img1(,) As Numerics.Complex, ByVal Img2(,) As Numerics.Complex, ByRef Result As Double)
            ...
            For i = 0 To Img1.GetLength(0) - 1
                For j = 0 To Img1.GetLength(1) - 1
                    ...
                    Result += Math.Abs(Img1(i, j).Magnitude ^ 2 / Sum1 - Img2(i, j).Magnitude ^ 2 / Sum2)
        ...
        End Sub
        Public Sub MagnitudeOverlap(ByVal Img1(,) As Numerics.Complex, ByVal Img2(,) As Double, ByRef Result As Double)
            ...
            For i = 0 To Img1.GetLength(0) - 1
                For j = 0 To Img1.GetLength(1) - 1
                    ...
                    Result += Math.Abs(Img1(i, j).Magnitude ^ 2 / Sum1 - Img2(i, j) ^ 2 / Sum2)
        ...
        End Sub
        Public Sub MagnitudeOverlap(ByVal Img1(,) As Numerics.Complex, ByVal Img2(,) As Integer, ByRef Result As Double)
        ...
        End Sub
        Public Sub MagnitudeOverlap(ByVal Img1(,) As Double, ByVal Img2(,) As Double, ByRef Result As Double)
            ...
            For i = 0 To Img1.GetLength(0) - 1
                For j = 0 To Img1.GetLength(1) - 1
                    ...
                    Result += Math.Abs(Img1(i, j) ^ 2 / Sum1 - Img2(i, j) ^ 2 / Sum2)
        ...
        End Sub
        Public Sub MagnitudeOverlap(ByVal Img1(,) As Double, ByVal Img2(,) As Integer, ByRef Result As Double)
        ...
        End Sub
        Public Sub MagnitudeOverlap(ByVal Img1(,) As Integer, ByVal Img2(,) As Double, ByRef Result As Double)
